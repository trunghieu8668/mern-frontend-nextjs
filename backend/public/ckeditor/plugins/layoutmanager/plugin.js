...
function LayoutBuilder() {
    ...
    defaultLayoutTemplates.push(new CKEDITOR.template('<div class="layoutmanager">' +
        ...
        '<div class="col-xs-12 col-sm-{size1} col-md-{size1} col-lg-{size1} col-xl-{size1} layout-column">' +
    ...
    defaultLayoutTemplates.push(new CKEDITOR.template('<div class="layoutmanager">' +
        ...
        '<div class="layout-column-one layout-column-editable"><p></p></div>' +
        '</div>' +
        '<div class="col-xs-12 col-sm-{size2} col-md-{size2} col-lg-{size2} col-xl-{size1} layout-column">' +
    ...
    defaultLayoutTemplates.push(new CKEDITOR.template('<div class="layoutmanager">' +
        ...
        '<div class="layout-column-two layout-column-editable"><p></p></div>' +
        '</div>' +
        '<div class="col-xs-12 col-sm-{size3} col-md-{size3} col-lg-{size3} col-xl-{size1} layout-column">' +
