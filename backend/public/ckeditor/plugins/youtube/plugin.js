					...
					onOk: function()
					{
						...
						if (this.getContentElement('youtubePlugin', 'txtEmbed').isEnabled()) {
							...
							if (this.getContentElement('youtubePlugin', 'chkResponsive').getValue() === true) {
								content += '<div class="youtube-embed-wrapper embed-responsive embed-responsive-16by9">';
							...
							if (this.getContentElement('youtubePlugin', 'chkNoEmbed').getValue() === true) {
								...
								content += '<iframe ' + (paramAutoplay ? 'allow="' + paramAutoplay + ';" ' : '') + 'class="embed-responsive-item h-100 w-100" src="' + url + '" ' + responsiveStyle;
